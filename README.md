...
另外，加载外部视频的功能也完全没做。:ghost: 目前的视频都是直接塞在资源文件里随app编译打包的，也导致仓库克隆要花很久（
...
@satgo1546：整挺好。我在（播放页右上角）弄了个可以显示一个边栏的功能，标签是“编辑”但其实里面什么都没做，你要做查看评论之类的话可以直接往里面删改，加油:cat: ……我突然发现这样是不是可以做成弹幕视频网站？怪起来了。
...
@OvertheBrain：其实我一直不明白这课的受众是什么学生。虽然理论上所有学生都能选，但这课上课内容的跨度很明显不是给非科班的人学的。你说给科班的人，他上课又喜欢前面加很多无关紧要的内容，正经的东西也不多讲。我之前在想功能的时候才发现很多我想搞的内容从他上课讲的东西上来讲都无从实现。

@satgo1546：是这样的。那些无关紧要的内容（关于像素是什么的科普……）很像是传统Windows程序设计的教材里章节引言里会搞的东西。（虽然连带介绍一下是好操作，但把这么大量的内容塞入半个学期每周末一次课的课表中还是太紧缩了。）
