...
这是一个趣味音视频播放器，它可以导入本地视频或录制新视频后播放。如果你对任何地方感到疑惑，程序的“帮助”页或许能帮到你。除了传统视频播放器的开始/暂停以及快进/快退功能以外，对于给定的视频，它能加载已有弹幕，也可以加入新弹幕，让观影过程更加有趣！

![img](image/README/1652538761149.png)

视频新弹幕发送页（编辑页）

![img](image/README/1652539216184.png)
